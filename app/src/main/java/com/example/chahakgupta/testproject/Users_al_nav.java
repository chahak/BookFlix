...
public class Users_al_nav extends ActionBarActivity implements OnItemClickListener {
 	    ...
 	    public void getItem(int position){
 	 	  FragmentManager fm=getSupportFragmentManager();
 			...
 			case 0: 
 				...
 				break;
 			case 1:
 				Intent i5 = new Intent(this,Users_list_al.class);
 				startActivity(i5);
 				break;
 			case 2:
 				Intent i6 = new Intent(this,Users_al_delete.class);
 				startActivity(i6);
 				break;
