...
byte[] image;
	...
	public void book_submit(View v){
		...
		final String bookname= e2.getText().toString().trim();
		final String publisher= e3.getText().toString().trim();
		final String author= e4.getText().toString().trim();
		final String price= e5.getText().toString().trim();
		final String condition= e6.getText().toString().trim();
		final String status = "not sold";
		final String buyer = "null";
       // String seller = "me";
		final String image = "b3";
        final String address = e7.getText().toString().trim();
        final String phone = e8.getText().toString().trim();
        ...
        if(TextUtils.isEmpty(bookname)||TextUtils.isEmpty(publisher)||TextUtils.isEmpty(author)||TextUtils.isEmpty(price)
                ||TextUtils.isEmpty(condition)||TextUtils.isEmpty(address)||TextUtils.isEmpty(phone)) {
            if(TextUtils.isEmpty(bookname))
                e2.setError("book name required");
            if(TextUtils.isEmpty(publisher))
                e3.setError("publisher name required");
            if(TextUtils.isEmpty(author))
                e4.setError("author name required");
            if(TextUtils.isEmpty(price))
                e5.setError("selling price required");
            if(TextUtils.isEmpty(condition))
                e6.setError("Condition of book required");
            if(TextUtils.isEmpty(address))
                e7.setError("Pick up address required");
            if(TextUtils.isEmpty(phone))
                e8.setError("Seller contact required");
            return;
        }
        else {
